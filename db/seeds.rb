...
cctv2 = TvStation.create(:name => "cctv2", :en_name =>"cctv2", :description => "中国中央电视经济频道")
cctv3 = TvStation.create(:name => "cctv3", :en_name =>"cctv3", :description => "中国中央电视音乐频道")
cctv4 = TvStation.create(:name => "cctv4", :en_name =>"cctv4", :description => "中国中央电视国际频道")
cctv5 = TvStation.create(:name => "cctv5", :en_name=>"cctv5", :description => "中国中央电视体育频道")
cctv6 = TvStation.create(:name => "cctv6", :en_name=>"cctv6", :description => "中国中央电视电影频道")
...
hntv = TvStation.create(:name => "湖南卫视", :en_name=>"hntv", :description => "湖南省级卫星电视台")
zjtv = TvStation.create(:name => "浙江卫视", :en_name=>"zjtv", :description => "浙江省级卫星电视台")
jstv = TvStation.create(:name => "江苏卫视", :en_name=>"jstv", :description => "江苏省级卫星电视台")
smgtv = TvStation.create(:name => "东方卫视", :en_name=>"dftv", :description => "上海市卫星电视台")
wxsport = TvStation.create(:name => "五星体育", :en_name=>"wxtv", :description => "上海文广所属体育体育频道")
gdsport = TvStation.create(:name => "广东体育", :en_name=>"gdtv", :description => "广东省级电视台所属体育频道")

local_tv.tv_stations << hntv
local_tv.tv_stations << zjtv
local_tv.tv_stations << jstv
local_tv.tv_stations << smgtv
local_tv.tv_stations << wxsport
local_tv.tv_stations << gdsport
...
# for sports
sports_tv.tv_stations << cctv5
sports_tv.tv_stations << wxsport
sports_tv.tv_stations << gdsport
